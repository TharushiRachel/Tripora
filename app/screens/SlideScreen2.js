...
function SlideScreen2({ navigation, onPress }) {
  return (
    // Background Image
    <ImageBackground
    ...
    >
      ...
      <View style={styles.topView1}>
        <View style={styles.imgContainer}>
          <Image style={styles.img} source={require("../assets/sc3.png")} />
          <View></View>
        </View>
      </View>
      ...
      <View style={styles.topView2}>
        <Text style={styles.title}>Meet Best Tour Guides</Text>
        <Text style={styles.subTitle}>
          In accordance with your choices, we can assist you in finding the best
          tour guide for your journey.
        </Text>
      </View>
