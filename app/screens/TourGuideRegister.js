...
// function TourGuideRegister({onPress}) {
  ...
  submitPressed(e) {
    ...
    e.preventDefault();
        ...
        axios.post('http://localhost:3000/tour-guide',tourguide)
        .then(response=>{
            alert('Data successfully inserted')
        })
        .catch(error=>{
            ...
            <View style={styles.container}>
                ...
                <View style={styles.inputTextWrapper}>
                    ...
                    {this.state.showLastnameError &&
                        <Text style={styles.errorText}>Please enter your username name.</Text>
                    }
                </View>
                ...
                <View style={styles.inputTextWrapper}>
                    ...
                    {this.state.showOccupationError &&
                        <Text style={styles.errorText}>Please enter your language proficiencies.</Text>
                    }
                </View>
